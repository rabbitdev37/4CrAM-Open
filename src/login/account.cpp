...
static bool mmo_auth_fromsql(AccountDB_SQL* db, struct mmo_account* acc, uint32 account_id) {
	...
	Sql_GetData(sql_handle, 16, &data, NULL); acc->passwd_type = (uint8) atoi(data);
#ifdef VIP_ENABLE
...
static bool mmo_auth_tosql(AccountDB_SQL* db, const struct mmo_account* acc, bool is_new) {
	...
	{// insert into account table
		...
		||  SQL_SUCCESS != SqlStmt_BindParam(stmt, 16, SQLDT_UCHAR,     (void*)&acc->passwd_type,     sizeof(acc->passwd_type))
#ifdef VIP_ENABLE
	...
	{// update account table
		...
		||  SQL_SUCCESS != SqlStmt_BindParam(stmt, 15, SQLDT_UCHAR,     (void*)&acc->passwd_type,     sizeof(acc->passwd_type))
#ifdef VIP_ENABLE
